...
/*
  ...
  Runs on OpenSource Logic board V4 in Gen2 charger. Commands all modules.
...
void setup()
{
  ...
  */
  ...
  pinMode(DIG_IN_3, INPUT); //IP2
  pinMode(DIG_IN_4, INPUT); //IP2
  //////////////////////////////////////////////////////////////////////////////////////
...
void Charger_msgs()
{
  ...
  if (dcdcenable)
  {
    ...
    /////////////////////////////////////////////////////////////////////////////////////////////////////////
    outframe.data.bytes[0] = 0xDC;  //DC DC enabled and set to 14v. This works!
    outframe.data.bytes[1] = 0x06;
...
void ACcurrentlimit()
{
  if (parameters.autoEnableCharger == 1)
  {
    ...
    {
      AcCurLimit = AvgCP.reading(accurlim);
    }

    if (parameters.phaseconfig == 0)
    {
      modulelimcur = (AcCurLimit / 3) * 1.5 ; // all module parallel, sharing AC input current
    }
    else
    {
      modulelimcur = AcCurLimit * 1.5; // one module per phase, EVSE current limit is per phase
